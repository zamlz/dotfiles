...
#+LAST_MODIFIED: [2021-04-26 Mon 12:52:28]
#+STATUP: content
  ...
  (let
    ...
    (setq org-todo-keyword-faces
          `(("TODO"      . (:weight bold :foreground ,black :background ,red))
            ("ROUTINE"   . (:weight bold :foreground ,black :background ,blue))
            ("MEETING"   . (:weight bold :foreground ,black :background ,magenta))
            ("PROJECT"   . (:weight bold :foreground ,black :background ,cyan))
            ("WAITING"   . (:weight bold :foreground ,black :background ,yellow))
            ("SOMEDAY"   . (:weight bold :foreground ,black :background ,(doom-darken white 0.5)))
            ("DONE"      . (:weight bold :foreground ,black :background ,green))
            ("COMPLETED" . (:weight bold :foreground ,black :background ,green))
            ))))
#+end_src
