...
#+LAST_MODIFIED: [2021-04-26 Mon 23:54:14]
#+STATUP: content
  ...
  (let
    ...
    (setq org-todo-keyword-faces
          `(("TODO"      . (:weight bold :foreground ,black :background ,red))
            ("MEETING"   . (:weight bold :foreground ,black :background ,magenta))
            ("WAITING"   . (:weight bold :foreground ,black :background ,yellow))
            ("SOMEDAY"   . (:weight bold :foreground ,black :background ,blue))
            ("DONE"      . (:weight bold :foreground ,black :background ,green :Strike-through t))
            ("CANCELLED" . (:weight bold :foreground ,black :background ,(doom-darken red 0.4) :Strike-through t))
            ))))
#+end_src
