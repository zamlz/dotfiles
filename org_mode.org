...
#+LAST_MODIFIED: [2021-04-12 Mon 18:32:32]
...
:header-args:conf: :tangle "/sudo::/etc/portage/sets/apps-emacs-org-mode" :mkdirp yes :comments both
:END:
...
Pretty straightforward except that you need to have =latex= installed and also =dvipng= as well. Need to figure out how to configure the size of the generated latex image.
