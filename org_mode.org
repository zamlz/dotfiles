...
#+LAST_MODIFIED: [2021-04-18 Sun 16:57:43]
...
(defun zamlz/configure-org-todo-keyword-faces ()
  ...
  (let
      ((black   (face-attribute 'term-color-black :foreground))
       (red     (face-attribute 'all-the-icons-red :foreground))
       (green   (face-attribute 'all-the-icons-green :foreground))
       (yellow  (face-attribute 'all-the-icons-yellow :foreground))
       (blue    (face-attribute 'all-the-icons-blue :foreground))
       (magenta (face-attribute 'all-the-icons-purple :foreground))
       (cyan    (face-attribute 'all-the-icons-cyan :foreground))
       (white   (face-attribute 'term-color-white :foreground)))
    (setq org-todo-keyword-faces
          `(("TODO"      . (:weight bold :foreground ,red :background ,(doom-blend red black 0.2)))
            ("ROUTINE"   . (:weight bold :foreground ,blue :background ,(doom-blend blue black 0.2)))
            ("MEETING"   . (:weight bold :foreground ,yellow :background ,(doom-blend yellow black 0.4)))
            ("PROJECT"   . (:weight bold :foreground ,cyan :background ,(doom-blend cyan black 0.2)))
            ("WAITING"   . (:weight bold :foreground ,yellow :background ,(doom-blend yellow black 0.2)))
            ("DONE"      . (:weight bold :foreground ,green :background ,(doom-blend green black 0.2)))
            ("COMPLETED" . (:weight bold :foreground ,green :background ,(doom-blend green black 0.2)))
            ))))
#+end_src

We must add it to a hook afterwards as well

#+begin_src emacs-lisp
(add-hook 'after-init-hook 'zamlz/configure-org-todo-keyword-faces)
#+end_src
