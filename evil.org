...
#+LAST_MODIFIED: [2021-05-12 Wed 22:32:11]
#+STARTUP: content
...
A simple undo system that is basically a wrapper over the existing undo system. Also make sure to integrate it with evil mode.

#+begin_src emacs-lisp
(use-package undo-fu)
#+end_src

TODO, should consider integrating =undo-fu-session= as well.
