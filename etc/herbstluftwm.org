#+TITLE: Herbstluftwm Tiling Window Manager for X11
#+AUTHOR: Amlesh Sivanantham
#+PROPERTY: header-args:shell :tangle ~/.config/herbstluftwm/autostart :mkdirp yes :shebang #!/bin/sh
...
** Setup Rules for Temrinals, Discord and Panels
...
** Verify that Event Hooks are not Started

This /may/ not work because =bar_events= is not longer a standalone script...
...
** Define Triggers and Event Hooks to Capture
