...
#+LAST_MODIFIED: [2021-03-20 Sat 20:39:47]
#+EXCLUDE_TAGS: TOC
...
- [[#gnuemacs-configuration][GNU/Emacs Configuration]]
  - [[#internal-configuration][Internal Configuration]]
    ...
    - [[#setup-personal-info][Setup Personal Info]]
...
Some environment variables should be overriden here. This is extremely important as I want certain program to behave differently if its being run from the emacs.
