...
#+LAST_MODIFIED: [2021-05-30 Sun 15:48:42]
#+STARTUP: content
...
So turns out that =s-replace-regexp= was part of an external package. I should figure out how to remove this dependency to this.
