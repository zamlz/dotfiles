...
#+LAST_MODIFIED: [2021-04-12 Mon 15:52:00]
...
:PROPERTIES:
:header-args:shell: :tangle "/sudo::/etc/portage/repo.postsync.d/eix" :mkdirp yes :shebang "#!/usr/bin/env bash" :comments both
:END:
...
:PROPERTIES:
:header-args:shell: :tangle "/sudo::/etc/portage/repo.postsync.d/egencache" :mkdirp yes :shebang "#!/bin/sh" :comments both
:END:
