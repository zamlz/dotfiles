...
#+LAST_MODIFIED: [2021-04-12 Mon 18:17:07]
...
:header-args:conf: :tangle "/sudo::/etc/portage/sets/apps-emacs-org-roam" :mkdirp yes :comments both
:END:
** Basic Configuration
...
Org roam also needs to have =sqlite= and =graphviz= for full functionality so let's make sure portage also installs that as well.
