...
#+LAST_MODIFIED: [2021-04-01 Thu 10:31:30]

URxvt is a popular fork of the Rxvt Terminal Emulator but with Unicode support for [[file:xorg.org][X11]].

* Xresouces Configuration
:PROPERTIES:
:header-args:C: :tangle ~/.Xresources.d/urxvt :mkdirp yes
:END:
** General Settings
