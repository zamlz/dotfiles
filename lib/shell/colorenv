# Source this file in your shell script to use these color variables
...
# echo -ne "${Bold}${Blue}${OnWhite}bold blue text on white background${Rst}";sleep 3;echo -e "${RESET_LINE}${Red}${OnYellow}becomes red text on yellow background${Rst}"
