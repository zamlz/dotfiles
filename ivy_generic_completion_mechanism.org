#+TITLE: Ivy Generic Completion Mechanism
#+AUTHOR: Amlesh Sivanantham (zamlz)
#+ROAM_ALIAS:
#+ROAM_TAGS: CONFIG SOFTWARE
#+CREATED: [2021-04-04 Sun 17:36]
#+LAST_MODIFIED: [2021-04-04 Sun 17:39:31]

Ivy is a generic completion mechanism for [[file:emacs.org][GNU/Emacs]].

* Configuration
:PROPERTIES:
:header-args:emacs-lisp: :tangle ~/.emacs.d/lisp/init-ivy.el :comments both :mkdirp yes
:END:
** Ivy
