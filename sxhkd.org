...
#+LAST_MODIFIED: [2021-04-01 Thu 11:09:48]
...
Here we make use of [[file:rofi.org][Rofi Dmenu]] to create various dmenus to do various tasks. Half of these are probably deprecated now that I'm using emacs.
