...
#+LAST_MODIFIED: [2021-05-11 Tue 17:20:37]
...
We're going to add one more special keybinding here which lets make use of the [[file:org_roam_protocol.org][Org-roam Protocol]].
...
By using [[file:xdg_utils.org][XDG Utils]], we can set the default browser for the system to be =qutebrowser=.
